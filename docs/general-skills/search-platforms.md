...
### [Tabbit (国内版->不推荐)](https://www.tabbit.com/)

### [Tabbit (国外版)](https://www.tabbit.ai/)

> 门槛：会魔法，或者你是海外用户

美团自研的 AI 驱动搜索引擎，国外版免费用户可以免费使用除 top0 梯队模型 外的其他前沿模型
...
- 类似维基百科，由原中文维基百科部分编辑创建，可以在境内直接访问
- 关于求闻与维基的关系（基于求闻百科的视角），可参考[此文](https://mp.weixin.qq.com/s/CzwQ_sEwQ31PfGJS7GxXZw)
